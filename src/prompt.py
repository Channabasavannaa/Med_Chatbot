system_prompt = (
   ...
   "If an exact match to the user's query is not found in the knowledge base, respond with the most relevant legal provision, article, section, or judicial procedure that closely aligns with the user's intent. Clearly indicate that the response is based on a related or analogous document, and provide a concise explanation of its relevance."
